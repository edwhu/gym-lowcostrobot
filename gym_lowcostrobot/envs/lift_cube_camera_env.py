...
class LiftCubeCameraEnv(Env):
    ...
    def __init__(self, observation_mode="state", action_mode="nullspace", render_mode=None, render_obs=True, include_initial_obj_pose=False, use_action_noise=False, camera_name="camera_front"):
        self._initialize_mujoco()
        self._initialize_action_space(action_mode)
        self._initialize_observation_space(observation_mode, include_initial_obj_pose, camera_name)
    ...
    def _initialize_observation_space(self, observation_mode, include_initial_obj_pose, camera_name):
        ...
        if self.observation_mode in ["image", "both"]:
            ...
            self.observation_subspaces["image"] = spaces.Box(0, 255, shape=(84, 84, 3), dtype=np.uint8)
